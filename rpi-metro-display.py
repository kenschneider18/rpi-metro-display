...
def main():
    ...
    station_code = Array(ctypes.c_wchar_p, sys.argv[3])
    direction = Array(ctypes.c_wchar_p, sys.argv[4])
    lines_file = Array(ctypes.c_wchar_p, sys.argv[6])
    stations_file = Array(ctypes.c_wchar_p, sys.argv[7])
